...
-- INSERT HOÁ ĐƠN
INSERT INTO HOADON (IDKH, IDNV, MAHD, NGAYTAO, LYDOHUY, NGAYTHANHTOAN, DONGIASAUGIAM, TONGTIEN, TRANGTHAIHD) VALUES
(1, 1, 'HD01', '2024-01-01', NULL, '2024-01-02', 100000, 150000, 1),
(2, 2, 'HD02', '2024-02-01', NULL, '2024-02-02', 200000, 250000, 1),
(3, 3, 'HD03', '2024-03-01', NULL, '2024-03-02', 300000, 350000, 0);
GO
UPDATE HOADON SET KHUYENMAI = 'KM01' WHERE ID = 1;
UPDATE HOADON SET KHUYENMAI = 'KM02' WHERE ID = 2;
UPDATE HOADON SET KHUYENMAI = 'KM03' WHERE ID = 3;
GO
